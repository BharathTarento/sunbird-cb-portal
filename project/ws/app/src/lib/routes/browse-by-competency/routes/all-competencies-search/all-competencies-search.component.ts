...
@Component({
  selector: 'ws-app-all-competencies-search',
  templateUrl: './all-competencies-search.component.html',
  styleUrls: ['./all-competencies-search.component.scss'],
})
export class AllCompetenciesSearchComponent implements OnInit, AfterViewInit {
